...
public class Worker : MonoBehaviour
{
    ...
    public void SpawnCubes(int totalCubes, List<Color> colors)
    {
        ...
        SpawnSideCubes(leftSpawnPoint, leftColors);
        SpawnSideCubes(rightSpawnPoint, rightColors);
    }

    // Spawn cubes for each side
    private void SpawnSideCubes(Transform spawnPoint, List<Color> colors)
    {
